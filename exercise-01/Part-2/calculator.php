...
<td>monthly</td>  
  ...
  <td>yearly </td> 
   ...
   <td><?php echo $_POST["Salary"] * 12 ?> </td>

   </tr>
   <tr> 

   <td>Tax amount</td> 
   <td><?php echo $_POST["taxfree"]?> </td>
   <td><?php echo $_POST["taxfree"] * 12 ?> </td>
 </tr>
 <tr> 
...
<tr> 
   ...
   <td><?php echo $_POST["Salary"] - $_POST["taxfree"]?> </td>
   <td><?php echo ($_POST["Salary"] - $_POST["taxfree"]) * 12 ?> </td>
</tr>
